        ...
        function exportInteretsToExcel() {
            try {
                ...
                if (totalsSection) {
                    ...
                    const totalHT = totalsSection.querySelector('.table-warning td:last-child strong')?.textContent?.trim() || '0';
                    const totalTTC = totalsSection.querySelector('.table-danger td:last-child strong')?.textContent?.trim() || '0';
